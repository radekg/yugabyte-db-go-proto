...
type TSHeartbeatResponsePB struct {
	...
	// Hash of transaction status table ids and versions, so that the TS knows when
	// to update the cached list of status tablet ids in the transaction manager.
	TxnTableVersionsHash *uint64 `protobuf:"varint,18,opt,name=txn_table_versions_hash,json=txnTableVersionsHash" json:"txn_table_versions_hash,omitempty"`
}
...
func (x *TSHeartbeatResponsePB) GetTxnTableVersionsHash() uint64 {
	if x != nil && x.TxnTableVersionsHash != nil {
		return *x.TxnTableVersionsHash
	}
	return 0
}
...
var file_yb_master_master_heartbeat_proto_rawDesc = []byte{
	...
	0x05, 0x52, 0x0b, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x12, 0x35,
	...
	0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x4a, 0x04, 0x08, 0x0d, 0x10, 0x0e, 0x22, 0xe0, 0x08,
	...
	0x68, 0x6f, 0x6c, 0x64, 0x42, 0x79, 0x74, 0x65, 0x73, 0x12, 0x35, 0x0a, 0x17, 0x74, 0x78, 0x6e,
	0x5f, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x5f, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x5f,
	0x68, 0x61, 0x73, 0x68, 0x18, 0x12, 0x20, 0x01, 0x28, 0x04, 0x52, 0x14, 0x74, 0x78, 0x6e, 0x54,
	0x61, 0x62, 0x6c, 0x65, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x48, 0x61, 0x73, 0x68,
	0x32, 0x80, 0x01, 0x0a, 0x0f, 0x4d, 0x61, 0x73, 0x74, 0x65, 0x72, 0x48, 0x65, 0x61, 0x72, 0x74,
	0x62, 0x65, 0x61, 0x74, 0x12, 0x50, 0x0a, 0x0b, 0x54, 0x53, 0x48, 0x65, 0x61, 0x72, 0x74, 0x62,
