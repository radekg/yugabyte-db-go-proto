...
var file_yb_encryption_encryption_proto_rawDesc = []byte{
...
var (
	...
	file_yb_encryption_encryption_proto_rawDescData = file_yb_encryption_encryption_proto_rawDesc
)

func file_yb_encryption_encryption_proto_rawDescGZIP() []byte {
	file_yb_encryption_encryption_proto_rawDescOnce.Do(func() {
		file_yb_encryption_encryption_proto_rawDescData = protoimpl.X.CompressGZIP(file_yb_encryption_encryption_proto_rawDescData)
	})
...
var file_yb_encryption_encryption_proto_goTypes = []interface{}{
...
func file_yb_encryption_encryption_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_yb_encryption_encryption_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yb_encryption_encryption_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yb_encryption_encryption_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_yb_encryption_encryption_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_yb_encryption_encryption_proto_rawDesc = nil
