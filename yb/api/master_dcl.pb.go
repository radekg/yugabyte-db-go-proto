...
var file_yb_master_master_dcl_proto_rawDesc = []byte{
...
var (
	...
	file_yb_master_master_dcl_proto_rawDescData = file_yb_master_master_dcl_proto_rawDesc
)

func file_yb_master_master_dcl_proto_rawDescGZIP() []byte {
	file_yb_master_master_dcl_proto_rawDescOnce.Do(func() {
		file_yb_master_master_dcl_proto_rawDescData = protoimpl.X.CompressGZIP(file_yb_master_master_dcl_proto_rawDescData)
	})
...
var file_yb_master_master_dcl_proto_goTypes = []interface{}{
	...
	(PermissionType)(0),                     // 15: yb.PermissionType
	(ResourceType)(0),                       // 16: yb.ResourceType
...
func file_yb_master_master_dcl_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_yb_master_master_dcl_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yb_master_master_dcl_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yb_master_master_dcl_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yb_master_master_dcl_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yb_master_master_dcl_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yb_master_master_dcl_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yb_master_master_dcl_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yb_master_master_dcl_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yb_master_master_dcl_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yb_master_master_dcl_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yb_master_master_dcl_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yb_master_master_dcl_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yb_master_master_dcl_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yb_master_master_dcl_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_yb_master_master_dcl_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   14,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_yb_master_master_dcl_proto_rawDesc = nil
